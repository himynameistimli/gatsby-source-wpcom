...
exports.sourceNodes = async ({
  ...
  entities = normalize.mapTagsCategoriesToTaxonomies(entities); // Normalize menu items

  entities = normalize.normalizeMenuItems(entities); // Creates links from entities to media nodes
